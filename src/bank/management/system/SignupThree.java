...
public class SignupThree extends JFrame implements ActionListener{
    ...
    String formno; 
     SignupThree(String formno){
        ...
        JLabel number = new JLabel("XXX-XXXX-XXXX-XXXX");
        ...
        c7 = new JCheckBox("I Here by declares that the above entered deatils are correct to the best of my knowledge");
        ...
        submit.setBounds(250, 705, 100, 30);
        ...
        cancel.setBounds(420, 705, 100, 30);
